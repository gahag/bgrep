    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("no-filename")
                ...
                .conflicts_with_all(&["files-with-matches", "files-without-matches"]),
        )
        .arg(
        ...
        .arg(
            Arg::with_name("files-with-matches")
                ...
                .overrides_with_all(&["only-matching", "byte-offset", "files-without-matches"]),
        )
        .arg(
            Arg::with_name("files-without-matches")
                ...
                .overrides_with_all(&["only-matching", "byte-offset", "files-with-matches"]),
        )
}
...
pub fn parse<T: Into<OsString> + Clone, A: IntoIterator<Item = T>>(
    args: A,
